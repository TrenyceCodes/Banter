 ...
 */
const getRooms = async (request: Request, response: Response) => {
    try {
 ...
 */
const getRoomById = async (request: Request, response: Response) => {
    ...
    try {
        ...
        const currentRoomMembers = await prisma.roomMembers.findMany({
            where: {
 ...
 * @returns 
 */
const deleteRoomById = async (request: Request, response: Response) => {
    const {roomId} = await request.params;
    const roomIdNumber = Number(roomId);
